공package com.morakmorak.morak_back_end.service;
...
public class ArticleServiceTest {
    ...
    public void upload_suc() throws Exception {
        ...
        given(categoryRepository.findByCategoryByName(any())).willReturn(Optional.of(Category.builder().build()));
    ...
    public void upload_fail4() throws Exception{
     ...
     public void upload_fail5() throws Exception{
         ...
         given(categoryRepository.findByCategoryByName(anyString())).willReturn(Optional.empty());
         //when
