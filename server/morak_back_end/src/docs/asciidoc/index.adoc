...
.response-fields
include::{snippets}/이메일_인증_요청_실패_409_중복/response-body.adoc[]
...
.response-fields
include::{snippets}/비밀번호_찾기_성공_201/response-body.adoc[]
...
.response-fields
include::{snippets}/비밀번호_찾기_실패_409/response-body.adoc[]
...
.response-fields
include::{snippets}/임시_패스워드_성공_200/response-body.adoc[]
...
.response-fields
include::{snippets}/임시_패스워드_실패_400/response-body.adoc[]
...
.response-fields
include::{snippets}/임시_패스워드_실패_404/response-body.adoc[]
